...
var _conanAwsApiGateway = require("../../lib/components/conanAwsApiGateway.js");

var _conanAwsApiGateway2 = _interopRequireDefault(_conanAwsApiGateway);

var _conanAwsApiGatewayStage = require("../../lib/components/conanAwsApiGatewayStage.js");

var _conanAwsApiGatewayStage2 = _interopRequireDefault(_conanAwsApiGatewayStage);

var _conanAwsApiGatewayResource = require("../../lib/components/conanAwsApiGatewayResource.js");
...
describe("ConanAwsApiGatewayStage(conan, name)", function () {
	...
	it("should extend ConanComponent", function () {
		stage.should.be.instanceOf(_conan.ConanComponent);
	});
