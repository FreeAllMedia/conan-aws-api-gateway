...
var _addPermissionStep = require("../../lib/steps/addPermissionStep.js");
...
describe("addPermissionStep", function () {
	...
	it("should be a function", function () {
		(typeof _addPermissionStep2.default === "undefined" ? "undefined" : _typeof(_addPermissionStep2.default)).should.equal("function");
	});

	describe("(parameters)", function () {
		beforeEach(function (done) {
			(0, _addPermissionStep2.default)(conan, context, function () {
				done();
			});
		});
	...
	describe("(permission added)", function () {
		...
		it("should return with no error", function (done) {
			(0, _addPermissionStep2.default)(conan, context, function (error) {
